            ...
            if (searchData != null) {
              ...
              if (searchData!.advertiserList != []) {
                for (var k = 0; k < searchData!.advertiserList!.length; k++) {
                  ...
                  if (searchData!.advertiserList![k].admitedoffers != []) {
                    for (var p = 0;
                        p <
                            searchData!
                                .advertiserList![k].admitedoffers!.length;
                        p++) {
                      searchData!.advertiserList![k].commonList.add(
                        CommonModel(
                            name: searchData!
                                .advertiserList![k].admitedoffers![p].name!,
                            image:
                                '${global.appInfo.baseUrls!.offerImageUrl}/${searchData!.advertiserList![k].admitedoffers![p].image}',
                            buttonText: 'Grab Now',
                            trackingLink: searchData!
                                .advertiserList![k].admitedoffers![p].gotourl!,
                            campaignId: searchData!
                                .advertiserList![k].admitedoffers![p].id!,
                            from: "admit"),
                      );
                    }
                  }
