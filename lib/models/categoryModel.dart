...
class CategoryModel {
  ...
  CategoryModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      cueCatId = json["cue_cat_id"] != null
          ? int.parse(json["cue_cat_id"].toString())
          : null;
      advId =
          json["adv_id"] != null ? int.parse(json["adv_id"].toString()) : null;
      ...
      rightTabDesc =
          json["right_tab_desc"] != null ? json["right_tab_desc"] : '';
      affiliatePartner =
          json["affiliate_partner"] != null ? json["affiliate_partner"] : '';
      regions = json["regions"] != null ? json["regions"] : '';
      topCashback = json["top_cashback"] != null
          ? int.parse(json["top_cashback"].toString())
          : 0;

      ads = json["ads"] != null && json["ads"] != []
          ? List<AdsModel>.from(json["ads"].map((x) => AdsModel.fromJson(x)))
          : [];
      cuecampaigns = json["cuecampaigns"] != null && json["cuecampaigns"] != []
          ? List<CampaignModel>.from(
              json["cuecampaigns"].map((x) => CampaignModel.fromJson(x)))
          : [];
      admitedoffers = json["admitadoffers"] != null &&
              json["admitadoffers"] != []
          ? List<AdmitedOffersModal>.from(
              json["admitadoffers"].map((x) => AdmitedOffersModal.fromJson(x)))
          : [];
      ...
      print("Exception - CategoryModel.dart - CategoryModel.fromJson():" +
          e.toString());
    }
  }
}
