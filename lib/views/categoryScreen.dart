                          ...
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GetPlatform.isWeb
                                  ? InkWell(
                                      onTap: () async {
                                        if (widget.category!.commonList[index]
                                                    .adId !=
                                                null &&
                                          ...
                                          Get.to(
                                            ...
                                            routeName: 'ads-detail',
                                                ...
                                                .commonList[index].from
                                                .toString() ==
                                            "admit") {
                                          await homeController
                                              .getAdmitedDetails(widget
                                                  .category!
                                                  .commonList[index]
                                                  .campaignId!);
