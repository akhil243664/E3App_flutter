...
import 'package:cashfuse/views/webScreen/webHomeMobileView.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        key: scaffoldKey,
        drawer: GetPlatform.isWeb ? WebDrawerWidget() : DrawerWidget(),
                                                                      ...
                                                                      (context) =>
                                                                          ProductDetailsScreen(
                                                                            title:
                                                                                "TOP SELLING PRODUCT",
                                                                            product:
                                                                                homeController.trendingProductList[index],
                                                                          )));
                                                        },
                                                        child: Container(
                                                          width: 150,
